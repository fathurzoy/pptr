	...
	try {
		...
		while (loop < parsedArgs.post + 10) {
			const selector = await page.$$(
				`div[aria-posinset="${parsedArgs.post}"] > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div:nth-of-type(1) > div[aria-label="Suka"]:nth-of-type(1)`
			)
		...
		const countLike = await page.$$eval(
			`div[aria-posinset="${parsedArgs.post}"] > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div:nth-of-type(1) > div[aria-label="Like"]:nth-of-type(1)`,
		...
		if (elementToInteract > 0) {
			...
			const selectorsLike = await page.$$(
				`div[aria-posinset="${parsedArgs.post}"] > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div > div:nth-of-type(1):nth-of-type(1) > div[aria-label="Suka"]:nth-of-type(1)`
			)

			const elementToLike =
				selectorsSuka.length > 0 ? selectorsSuka : selectorsLike
			console.log(elementToLike.length, 'element to like')
			...
			const screenshotPath = `./tests/e2e/screenshotsFb/likeFb-${timestamp}.png` // menggabungkan timestamp ke dalam nama file
