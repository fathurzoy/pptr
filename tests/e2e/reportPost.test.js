/* 	npm run test:report id=j5vvm2b post=2 problem=1 kekerasan=2 link=efasnakindramayu
	npm run test:report id=j5vvm2b post=2 link=auliakechil.kechil.3 problem=Kekerasan kekerasanOpsi="Konten sadis"
	npm run test:report id=j5vvm2b post=2 link=auliakechil.kechil.3 problem=Ketelanjangan ketelanjanganOpsi=Ketelanjangan Orang Dewasa
	npm run test:report id=j5vvm2b post=2 link=auliakechil.kechil.3 problem="Penjualan tidak resmi" penjualanOpsi="Obat Terlarang"
	npm run test:report id=j5vvm2b post=2 link=auliakechil.kechil.3 problem="Informasi palsu" informasiPalsuOpsi="Obat Terlarang"
	npm run test:report id=j5vvm2b post=2 link=auliakechil.kechil.3 problem="Terorisme"
	npm run test:report id=j5vvm2b post=2 link=auliakechil.kechil.3 problem="Ujaran Kebencian" ujaranOpsi="Asal Negara"
	npm run test:report id=j5vvm2b post=3 link=auliakechil.kechil.3 problem="Hal Lain" halOpsi="Kekayaan intelektual" */

// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Spam" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Ketelanjangan Orang Dewasa"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Bersifat Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Aktivitas Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Eksploitasi Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Layanan Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Melibatkan anak"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ketelanjangan" pilihOpsi="Membagikan gambar pribadi"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Kekerasan" pilihOpsi="Konten Sadis"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Kekerasan" pilihOpsi="Kematian atau Cedera Parah"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Kekerasan" pilihOpsi="Ancaman Kekerasan"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Kekerasan" pilihOpsi="Penyiksaan Hewan"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Kekerasan" pilihOpsi="Kekerasan Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Kekerasan" pilihOpsi="Hal Lain"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Penjualan tidak resmi" pilihOpsi="Obat Terlarang"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Penjualan tidak resmi" pilihOpsi="Senjata"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Penjualan tidak resmi" pilihOpsi="Hewan Langka"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Penjualan tidak resmi" pilihOpsi="Hewan Lain"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Penjualan tidak resmi" pilihOpsi="Hal Lain"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Pelecehan" pilihOpsi="Saya"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Pelecehan" pilihOpsi="Teman" typeText="a"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Terorisme" 

// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Ras atau Etnis" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Asal Negara" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Afiliasi Agama" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Kasta Sosial" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Orientasi Seksual" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Jenis Kelamin atau Identitas Gender" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Disabilitas atau Penyakit" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Ujaran kebencian" pilihOpsi="Hal Lain"

// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Informasi palsu" pilihOpsi="Kesehatan" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Informasi palsu" pilihOpsi="Politik" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Informasi palsu" pilihOpsi="Isu Sosial" 
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Informasi palsu" pilihOpsi="Hal Lain" 

// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Bunuh diri atau melukai diri sendiri" 

// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Kekayaan intelektual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Penipuan"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Pelanggaran Privasi"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Mengejek Korban"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Perundungan (Bullying)"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Kekerasan Anak"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Penyiksaan Hewan"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Aktivitas Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Bunuh diri atau melukai diri sendiri"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Ujaran kebencian"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Mempromosikan Penggunaan Obat Terlarang"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Foto Intim Non-Konsensual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Ekspoitasi Seksual"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Pelecehan"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Penjualan tidak resmi"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Kekerasan"
// npm run test:report id=j5vvm2b post=2 link="auliakechil.kechil.3" problem="Hal Lain" pilihOpsi="Membagikan gambar pribadi"
		...
		if (countTindakan > 0) {
			...
			if (parsedArgs.post) {
				...
				await page.waitForXPath(
					"//span[normalize-space()='Saya khawatir tentang postingan ini.'][1]",
					{
						timeout: 5000,
					}
				)
				...
				await page.waitForSelector(`div[aria-label='Tutup']`, {
					timeout: 5000,
				})
								...
								if (text === 'Spam') {
									...
									for (const elementKetelanjangan of ketelanjanganOpsi) {
										...
										if (parsedArgs.pilihOpsi === text2) {
											...
											if (text2 === 'Aktivitas Seksual') {
												await elementKetelanjangan.click()
												await page.waitForTimeout(1000)
												console.log('Aktivitas Seksual!')
												await page.waitForTimeout(1000)
												try {
													const buttonKirim = await page.$(
														'div[aria-label="Kirim"]'
									...
									for (const elementPenjualan of penjualanOpsi) {
									...
									for (const elementPelecehan of pelecehanOpsi) {
										...
										if (parsedArgs.pilihOpsi === text4) {
											console.log(text4)
											console.log(parsedArgs.pilihOpsi)
											console.log('qw')
											if (text4 === 'Saya') {
											...
											if (text4 === 'Teman') {
												...
												const clickTemanPelecehan = await page.$$(
													`ul[role="listbox"] li:nth-child(1)`
												)
												console.log(clickTemanPelecehan)
												await clickTemanPelecehan[0].click()
												await page.waitForTimeout(2000)
									...
									for (const elementhalLain of halOpsi) {
										...
										console.log('parsedArgs.halOpsi', parsedArgs.pilihOpsi)
										if (parsedArgs.pilihOpsi === text7) {
