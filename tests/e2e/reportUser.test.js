// npm run test:reportUser id=j65aprq link="angger.bagussetiawan.3" problem="Berpura-pura Menjadi Orang Lain" pilihOpsi="Teman" temanType="Mba Ati"
// npm run test:reportUser id=j65aprq link="angger.bagussetiawan.3" problem="Berpura-pura Menjadi Orang Lain" pilihOpsi="Bisnis" BisnisType="Triple A"
//  npm run test:reportUser id=j65aprq link="angger.bagussetiawan.3" problem="Berpura-pura Menjadi Orang Lain" pilihOpsi="Selebriti" SelebritiType="Mbako Sumbing"
//  npm run test:reportUser id=j65aprq link="angger.bagussetiawan.3" problem="Saya Ingin Membantu" pilihOpsi="Bunuh diri"
